...
public final class FabricLoader {
    ...
    public List<ModContainer> getAllMods() { return List.of(); }
    public Optional<ModContainer> getModContainer(String id) { return isModLoaded(id) ? Optional.empty() : Optional.empty(); }
