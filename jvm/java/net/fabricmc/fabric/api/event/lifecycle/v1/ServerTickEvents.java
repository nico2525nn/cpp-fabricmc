...
public final class ServerTickEvents {
    ...
    public static final Event<Start> START = new Event<>(CppModRuntime::registerTickStart);
    public static final Event<End> END = new Event<>(CppModRuntime::registerTickEnd);
