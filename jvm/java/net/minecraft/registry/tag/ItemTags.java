...
/**
 * The vanilla 1.21.4 item-tag key table.
 *
 * The native server owns tag contents.  These keys are nevertheless part of
 * the public server ABI: Fabric API and ordinary server mods resolve them
 * while registering conventions, recipes, and gameplay hooks.  Keep the
 * complete Yarn field table here so class linking does not depend on which
 * particular tag a mod happens to touch.
 */
public final class ItemTags {
    ...
    public static final TagKey<Item> VANISHING_ENCHANTABLE = of("vanishing_enchantable");
    ...
    public static final TagKey<Item> DURABILITY_ENCHANTABLE = of("durability_enchantable");
    public static final TagKey<Item> TRIM_MATERIALS = of("trim_materials");
    public static final TagKey<Item> BOW_ENCHANTABLE = of("bow_enchantable");
    public static final TagKey<Item> EQUIPPABLE_ENCHANTABLE = of("equippable_enchantable");
    public static final TagKey<Item> CROSSBOW_ENCHANTABLE = of("crossbow_enchantable");
    public static final TagKey<Item> MINING_ENCHANTABLE = of("mining_enchantable");
    public static final TagKey<Item> MINING_LOOT_ENCHANTABLE = of("mining_loot_enchantable");
    public static final TagKey<Item> FISHING_ENCHANTABLE = of("fishing_enchantable");
    public static final TagKey<Item> WOODEN_FENCES = of("wooden_fences");
    public static final TagKey<Item> TRIDENT_ENCHANTABLE = of("trident_enchantable");
    public static final TagKey<Item> NOTEBLOCK_TOP_INSTRUMENTS = of("noteblock_top_instruments");
    public static final TagKey<Item> HEAD_ARMOR_ENCHANTABLE = of("head_armor_enchantable");
    public static final TagKey<Item> ARMOR_ENCHANTABLE = of("armor_enchantable");
    public static final TagKey<Item> SWORD_ENCHANTABLE = of("sword_enchantable");
    public static final TagKey<Item> WEAPON_ENCHANTABLE = of("weapon_enchantable");
    ...
    public static final TagKey<Item> LEG_ARMOR_ENCHANTABLE = of("leg_armor_enchantable");
    public static final TagKey<Item> CHEST_ARMOR_ENCHANTABLE = of("chest_armor_enchantable");
    ...
    public static final TagKey<Item> SHARP_WEAPON_ENCHANTABLE = of("sharp_weapon_enchantable");
    public static final TagKey<Item> REPAIRS_WOLF_ARMOR = of("repairs_wolf_armor");
    public static final TagKey<Item> MACE_ENCHANTABLE = of("mace_enchantable");
    ...
    public static final TagKey<Item> FIRE_ASPECT_ENCHANTABLE = of("fire_aspect_enchantable");
    ...
    public static final TagKey<Item> FOOT_ARMOR_ENCHANTABLE = of("foot_armor_enchantable");
