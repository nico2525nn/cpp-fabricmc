...
static void printUsage(const char* program) {
    std::printf(
        ...
        "  --level-seed=<seed|text>   Numeric, textual, or empty random seed\n"
        "  --motd=<text>              Server list description\n"
        "  --max-players=<n>          Player limit\n"
        "  --view-distance=<2..32>    Client view distance\n"
        "  --simulation-distance=<2..32>\n"
        "  --whitelist=<true|false>   Enable whitelist\n"
        "  --online-mode=<true|false> Enable authentication mode\n"
        "  --enforce-secure-profile=<true|false>\n"
        "  --network-compression-threshold=<n>\n"
        "  --resource-pack=<url>      Client resource-pack URL\n"
        "  --resource-pack-sha1=<hex> Resource-pack SHA-1\n"
        ...
        "  --jvm-classes=<path>       Embedded Java classes directory\n"
        "  --jvm-mods=<path>          Server-side Java mod directory\n"
        "  --jvm-config=<path>        Java mod configuration directory\n"
        "  --jvm-java-home=<path>     Java home\n"
        "  --jvm-library=<path>       JVM library\n"
        "  --jvm-libraries=<path>     JVM libraries directory\n"
