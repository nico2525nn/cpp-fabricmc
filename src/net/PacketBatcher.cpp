            ...
            for (auto &g : groups) {
                ...
                if (vec.size() >= 2) {
                    ...
                    for (auto &r : vec) {
                        ...
                        // vanilla/Prismarine: (state<<12)|(localX<<8)|(localZ<<4)|localY (not y<<8|z<<4|x — that swap placed blocks at
                        // wrong section-local coords; see docs/SPEC_WIRE.md#bundle-and-section-blocks.
