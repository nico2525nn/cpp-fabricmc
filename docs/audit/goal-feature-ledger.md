...
| 59 | Tab completion | DONE | **PARTIAL** | `Tree.hpp:206` + `Commands.cpp:1243` | The owned live fixture decoded `/gi` as transaction `1`, range `start=1,length=2`, one match `give`, and no tooltip; other command and argument-specific lists remain unverified. |
