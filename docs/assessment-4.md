...
> **Target:** `cpp-fabricmc` HEAD `985b3d1` (plan40 C-05 100 + C-06 80 + C-07 22 + C-08 41, protocol 769, DataVersion 4189, Yarn 1.21.4) vs Vanilla **Fabric 1.21.4** (Mojang 1.21.4, `minecraft-data 1.21.4`, Yarn `1.21.4+build.9`)
> **Date:** 2026-09-01 (updated wt40/test)
...
> **Result:** **12 gaps** (C-01〜C-12) **FIXED 8/12, OPEN 4/12** (C-01〜C-08 FIXED plan39-40 wt39/wt40, C-09〜C-12 OPEN)。全 12 項目が FIXED になった時点で「正直な見立て 87/100 → 90/100」到達とみなす（A 38/40・B 26-27/30・C 13-14/15・D 14/15, `tools/score_review.py` 100/100 フレーム）。
...
> **All gaps verified 2026-09-01 via local grep `src/...:line` + `wc -l`/`find` counts on HEAD `985b3d1` (+wt40/test). Vanilla specs are Yarn 1.21.4 / minecraft.wiki / minecraft-data 1.21.4. 12 delivered, FIXED 8/12 (C-01〜C-08 plan39-40), OPEN 4/12 (C-09〜C-12 remain, plan41).**
